    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                <h2 className="text-2xl font-bold mb-4 text-gray-900">{initialData ? 'Edit Scholarship' : 'Add Scholarship'}</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <label className="block text-gray-800 font-medium mb-1">University</label>
                        <input
                            type="text"
                            value={university}
                    ...
                    <div className="mb-3">
                        <label className="block text-gray-800 font-medium mb-1">Deadline</label>
                        <input
                            type="date"
                            value={deadline}
